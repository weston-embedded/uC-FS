...
*
* Filename : fs_dev_nor_micron_np5q.c
* Version  : V4.08.01
*********************************************************************************************************
*/
...
#define  FS_DEV_NOR_MICRON_NP5Q_MODULE
...
#include  "../../../Source/fs.h"
#include  "fs_dev_nor_micron_np5q.h"
...
#define  FS_DEV_NOR_PHY_MANUF_ID_MICRON                0x20u    /* Manufacturer ID.                                     */


#define  FS_DEV_NOR_PHY_PAGE_SIZE                        64u

#define  FS_DEV_NOR_PHY_MAX_PAGE_PGM_ms                   3u
#define  FS_DEV_NOR_PHY_MAX_128K_BLK_ERASE_ms           950u
...
*/
                                                                /* ------------------ READ COMMANDS ------------------- */
#define  FS_DEV_NOR_PHY_CMD_ARRAY_READ                  0x0Bu   /* Read Array                                           */
                                                                /* ------------- PROGRAM & ERASE COMMANDS ------------- */
#define  FS_DEV_NOR_PHY_CMD_128K_BLOCK_ERASE            0xD8u   /* Block Erase (128-KBytes).                            */
...
#define  FS_DEV_NOR_PHY_CMD_STATUS_REG_BYTE_WRITE       0x01u   /* Write status register byte 1.                        */
...
static  const  FS_DEV_NOR_PHY_DESC  FSDev_NOR_PHY_DevTbl[] = {
    {0xDA16u,     32u, 128u * 1024u},
    {0xDA17u,     64u, 128u * 1024u},
    {0xDA18u,    128u, 128u * 1024u},
};
...
const  FS_DEV_NOR_PHY_API  FSDev_NOR_Micron_NP5Q = {
    FSDev_NOR_PHY_Open,
    FSDev_NOR_PHY_Close,
    FSDev_NOR_PHY_Rd,
    FSDev_NOR_PHY_Wr,
                                  ...
                                  FS_ERR               *p_err)
{
    ...
    if (p_phy_data->AddrBase != 0u) {
        ...
        FS_TRACE_DBG(("NOR PHY NP5Q: \'AddrBase\' = 0x%08X != 0x00000000: Corrected.\r\n", p_phy_data->AddrBase));
    }

    if (p_phy_data->RegionNbr != 0u) {
        p_phy_data->RegionNbr  = 0u;
        FS_TRACE_DBG(("NOR PHY NP5Q: \'RegionNbr\' = %d != 0: Corrected.\r\n", p_phy_data->RegionNbr));
    }
                                                                /* ---------------------- INIT HW --------------------- */
    ...
    FSDev_NOR_BSP_SPI.Rd(p_phy_data->UnitNbr, &id[0], 3u);      /* Rd 4-byte ID.                                        */
    ...
    if (id_manuf != FS_DEV_NOR_PHY_MANUF_ID_MICRON) {           /* Validate manuf ID.                                   */
        FS_TRACE_INFO(("NOR PHY NP5Q: Unrecognized manuf ID: 0x%02X != 0x%02X.\r\n", id_manuf, FS_DEV_NOR_PHY_MANUF_ID_MICRON));
       *p_err = FS_ERR_DEV_IO;
        return;
    }
    ...
    if (found == DEF_NO) {
        FS_TRACE_INFO(("NOR PHY NP5Q: Unrecognized dev ID: 0x%02X.\r\n", id_dev));
       *p_err = FS_ERR_DEV_IO;
        return;
    }
                                                                ...
                                                                /* ------------------- SAVE PHY INFO ------------------ */
    FS_TRACE_INFO(("NOR PHY NP5Q: Recognized device:  Part nbr: %s\r\n", FSDev_NOR_PHY_NameTbl[desc_nbr]));
    ...
    FS_DEV_NOR_PHY_CMD(p_phy_data, &cmd[0], 1u);                /* Wr cmd.                                              */
                                                                ...
                                                                /* ----------------------- SR WR ---------------------- */
    cmd[0] = FS_DEV_NOR_PHY_CMD_STATUS_REG_BYTE_WRITE;
    cmd[1] = 0u;
                                      ...
                                      FS_ERR               *p_err)
{
    ...
    switch (size) {
        case 131072u:                                           /* 128KBytes Block erase.                               */
             cmd_erase = FS_DEV_NOR_PHY_CMD_128K_BLOCK_ERASE;
             timeout   = FS_DEV_NOR_PHY_MAX_128K_BLK_ERASE_ms * 2u;
             break;
